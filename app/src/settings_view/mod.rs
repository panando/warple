...
impl SettingsView {
    pub fn new(page: Option<SettingsSection>, ctx: &mut ViewContext<Self>) -> Self {
        ...
        let mut nav_items = vec![
            // // SettingsNavItem::Page(SettingsSection::Account), // Account 已禁用 // Account 已禁用
            // SettingsNavItem::Umbrella(SettingsUmbrella::new(  // Agents 已禁用
            //     "Agents",
            ...
            SettingsNavItem::Umbrella(SettingsUmbrella::new(
                "Cloud platform",
                vec![
                    // // SettingsSection::CloudEnvironments, // Cloud 已禁用 // Cloud 已禁用
                    // // SettingsSection::OzCloudAPIKeys, // Cloud API Keys 已禁用 // Cloud API Keys 已禁用
                ],
            )),
        ...
        let initial_page = match page {
            ...
            Some(SettingsSection::Code) => SettingsSection::EditorAndCodeReview, // Indexing 已禁用
    ...
    pub fn set_and_refresh_current_page_internal(
        ...
        let section = match section {
            ...
            SettingsSection::Code => SettingsSection::EditorAndCodeReview, // Indexing 已禁用
            other => other,
        };
